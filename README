...
> [!NOTE]
> For compiling the build, add `glfw3.dll` and `libglfw3dll.a` into the build folder. Also current state of the project doesn't reflect the provided images